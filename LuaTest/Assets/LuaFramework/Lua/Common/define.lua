...
Urls = {	
	...
	-- method: Post
	SignUp = "http://sop.73cloud.top/Account/AddOrUpdate?", 		
	-- 2. params (1). account, (2). password(md5);
	-- method: Post
	Login = "http://sop.73cloud.top/Account/Login?", 		
	-- 3. params (1). code, (2). account, (3). oldpassword(md5), (4). newpassword(md5); 
	-- method: Post
	UpdatePassword = "http://sop.73cloud.top/Account/UpdatePassword?",
	-- 4. params (1). phone, (2). type('1': SingUp, '2': UpdatePassword)
	-- method: Post
	SendSMS = "http://sop.73cloud.top/CommonComponents/SendSMS?",	
	-- 5. params 
	-- method: Post
	GetAllProductTypes = "http://sop.73cloud.top/ProductType/GetAllProductTypes", 
	-- 6. params (1). Name, (2). cateid, (3). keywords
	-- method: Get
	GetList = "http://sop.73cloud.top/Product/GetList?", 
	-- 7. params (1). keywords
	-- method: Get
	GetModelInfo = "http://sop.73cloud.top/Product/GetModelInfo?", 
}
