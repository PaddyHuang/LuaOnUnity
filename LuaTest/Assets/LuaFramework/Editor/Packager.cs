...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("items" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Items");
        AddBuildMap("main" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/MainPanel");
        AddBuildMap("list" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/ListPanel");
        AddBuildMap("search" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/SearchPanel");
        AddBuildMap("fetchpwd" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/FetchPwdPanel");
        AddBuildMap("login" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/LoginPanel");
        AddBuildMap("signup" + AppConst.ExtName, "*.prefab", "Assets/Prefab/UI/Panels/SignUpPanel");
    }
